...
import org.tarena.note.web.controller.note.SaveNoteController;
...
public class TestSaveNoteController {
	@Autowired//注入要测试的Controller
	private SaveNoteController controller;
	//发送测试请求
	...
	public void test1() throws Exception{
		...
		.param("cn_note_id", "0d83ca55b7a9476298bd41759299f927")//传数据
		.param("cn_note_body", "保存笔记测试二");
