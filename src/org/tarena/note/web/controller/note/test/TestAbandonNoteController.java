...
import org.tarena.note.web.controller.note.AbandonNoteController;
...
public class TestAbandonNoteController {
	@Autowired//注入要测试的Controller
	private AbandonNoteController controller;
	//发送测试请求
	...
	public void test1() throws Exception{
		...
		.post("/note/abandon.do")
		.param("noteId", "c49c26d983624c05978dc233377fb613");//传数据
