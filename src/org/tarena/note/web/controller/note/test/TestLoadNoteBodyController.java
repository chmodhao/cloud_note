...
import org.tarena.note.web.controller.note.LoadNoteBodyController;
...
public class TestLoadNoteBodyController {
	@Autowired//注入要测试的Controller
	private LoadNoteBodyController controller;
	//发送测试请求
	...
	public void test1() throws Exception{
		...
		.post("/note/notebody.do")
		.param("noteId", "508eabb69cfc455ab9c3dcc37150bfe0");//传数据
