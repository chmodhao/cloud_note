...
import org.tarena.note.web.controller.note.ShareNoteController;
...
public class TestShareNoteController {
	@Autowired//注入要测试的Controller
	private ShareNoteController controller;
	//发送测试请求
